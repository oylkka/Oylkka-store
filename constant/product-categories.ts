...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'security-systems', label: 'Home Security Systems' },
    ],
  },
  {
    value: 'baby-kids',
    ...
    subcategories: [
      ...
      { value: 'nursery', label: 'Nursery Furniture' },
      { value: 'toys', label: 'Toys' },
      { value: 'kids-books', label: 'Kids Books' },
    ],
  },
  {
    value: 'automotive',
    ...
    subcategories: [
      ...
      { value: 'motorcycle-gear', label: 'Motorcycle Gear' },
      { value: 'oil-fluids', label: 'Oil & Fluids' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'fish-aquatics', label: 'Fish & Aquatic Pets' },
      { value: 'reptile-supplies', label: 'Reptile Supplies' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { value: 'carry-on', label: 'Carry-On Luggage' },
    ],
  },
];
