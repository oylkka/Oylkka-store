  ...
  return (
    <footer className='relative overflow-hidden bg-background text-foreground'>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 25px 25px, var(--foreground) 2%, transparent 0%), radial-gradient(circle at 75px 75px, var(--foreground) 2%, transparent 0%)',
      ...
      <div className='relative border-b border-border'>
        <div className='container py-6'>
          <div className='grid grid-cols-2 gap-6 md:grid-cols-4'>
            <div className='flex items-center gap-3 rounded-xl bg-muted/20 p-3 transition-all hover:bg-muted/30'>
            ...
            <div className='flex items-center gap-3 rounded-xl bg-muted/20 p-3 transition-all hover:bg-muted/30'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>Save up to 25%</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className='flex items-center gap-3'>
                <a
                  ...
                  className='group hover:bg-primary flex h-10 w-10 items-center justify-center rounded-full bg-muted text-muted-foreground transition-all hover:text-white'
                  aria-label='Facebook'
                >
                  <Facebook
                    size={18}
            ...
            <div>
              ...
              <ul className='space-y-3'>
                <li>
                  <Link
                    href='/products'
                    className='group hover:text-primary flex items-center text-sm text-muted-foreground transition-colors'
                  >
          ...
          <div className='lg:col-span-3'>
            ...
            <form className='mb-6'>
              ...
              <p className='text-xs text-muted-foreground'>
                ...
                <Link
                  href='/privacy-policy'
                  className='hover:text-primary text-muted-foreground underline underline-offset-2'
                >
                  {' '}
                  Privacy Policy
                </Link>
            ...
            <div className='rounded-xl bg-muted/30 p-4'>
              ...
              <div className='flex flex-wrap gap-3'>
                <Button
                  variant='outline'
                  size='sm'
                  className='h-10 border-border bg-muted/50 text-xs text-muted-foreground hover:bg-muted hover:text-foreground'
                >
        ...
        <div className='container'>
          <div className='flex flex-col items-center justify-between gap-6 md:flex-row'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-3'>
              <div className='flex h-10 items-center gap-2 rounded-lg bg-muted/40 px-3 text-xs text-muted-foreground'>
            ...
            {/* Payment Methods */}
            <div className='flex items-center gap-2'>
              <div className='flex h-8 w-12 items-center justify-center rounded bg-muted/60 text-muted-foreground transition-colors hover:bg-muted'>
                <CreditCard size={16} />
              </div>
              <div className='flex h-8 w-12 items-center justify-center rounded bg-muted/60 text-muted-foreground transition-colors hover:bg-muted'>
                <Banknote size={16} />
