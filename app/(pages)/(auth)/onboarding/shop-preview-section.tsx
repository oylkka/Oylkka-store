    ...
    <div className='sticky top-4 space-y-4'>
      ...
      <div className='overflow-hidden rounded-lg border bg-white shadow-sm'>
        ...
        <div className='flex justify-between border-t p-3'>
          <button
            type='button'
            className='mr-1 flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-2 py-1.5 text-xs text-gray-700 transition-colors hover:bg-gray-50'
          >
            Contact
          </button>
          <button
            type='button'
            className='ml-1 flex w-full items-center justify-center rounded-md bg-blue-500 px-2 py-1.5 text-xs text-white transition-colors hover:bg-blue-600'
          >
            Visit Shop
          </button>
        </div>
