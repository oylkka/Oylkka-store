...
import { useAdminProductById } from '@/services';

import { BasicInformationCard } from '../../../../vendor/products/add/basic-information';
import PricingAndInventory from '../../../../vendor/products/add/pricing-and-inventory';
import { ProductCondition } from '../../../../vendor/products/add/product-condition';
import { ProductDimensions } from '../../../../vendor/products/add/product-dimension';
import { ProductFormContext } from '../../../../vendor/products/add/product-form-context';
import { ProductFormProvider } from '../../../../vendor/products/add/product-form-provider';
import type {
  ProductFormInput,
  ProductFormValues,
} from '../../../../vendor/products/add/product-form-type';
import { ProductImagesCard } from '../../../../vendor/products/add/product-image';
import ProductSeo from '../../../../vendor/products/add/product-seo';
import ProductStatus from '../../../../vendor/products/add/product-status';
import ProductVariant from '../../../../vendor/products/add/product-variant';
...
function AdminEditProductForm({ productId }: { productId: string }) {
