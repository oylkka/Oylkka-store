        ...
        <div className="relative -mt-24 flex flex-col sm:flex-row sm:items-end sm:space-x-5">
          ...
          <div className="mt-6 flex flex-col space-y-3 sm:mt-0 sm:flex-row sm:space-y-0 sm:space-x-3">
            <Button
              ...
              asChild
            >
              <a href={`mailto:${shop.shopEmail}`}>
                <Mail className="mr-2 h-4 w-4" />
                Contactcompletel Contact
              </a>
            </Button>
            <Button
              variant="default"
        ...
        <motion.div variants={itemVariants} className="mt-8">
          <Tabs defaultValue="products" className="w-full">
            <TabsList className="grid w-full grid-cols-4 md:w-auto">
              <TabsTrigger value="products">All value ody Products</TabsTrigger>
              ...
              <TabsContent value="policies" className="mt-0">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Learn about {shop.name}&apos;s shipping, returns, and
                      other policies.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
...
function ShopSkeleton() {
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <div className="relative h-64 w-full bg-gray-200 sm:h-80 md:h-96" />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative -mt-24 flex flex-col sm:flex-row sm:items-end sm:space-x-5">
          <Skeleton className="h-32 w-32 rounded-xl border-4 border-white bg-gray-200 sm:h-40 sm:w-40" />
          <div className="mt-6 sm:mt-0 sm:flex-1">
  ...
  return (
    <div className="overflow-hidden rounded-lg border bg-white shadow">
      ...
      <div className="p-4">
        ...
        <Skeleton className="mt-4 h-6 w-1/3 bg-gray-200" />
      </div>
    </div>
  );
}
