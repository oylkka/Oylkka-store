...
import { ChevronLeft, ImagePlus, Loader2, Send, User, X } from 'lucide-react';
...
import {
  ...
  useVendorConversationDetail,
} from '@/services/conversations';

export const Route = createFileRoute('/dashboard/vendor/shop/messages/$id')({
  beforeLoad: ({ context }) => {
...
function RouteComponent() {
  ...
  const { data: convoData, isLoading: convoLoading } =
    useVendorConversationDetail(conversationId);
    ...
    return (
      <div className='flex flex-col items-center justify-center py-20 gap-4 text-center'>
        ...
        <Button size='sm' asChild>
          <Link to='/dashboard/vendor/shop/messages'>Back to Messages</Link>
        </Button>
      </div>
    );
  }
